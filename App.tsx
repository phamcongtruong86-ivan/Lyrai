...
export default function App() {
  ...
  if (isDesktop && activeTab === 'map') {
    return (
      <>
        <div className="h-[100dvh] w-full flex bg-[#0F172A] overflow-hidden">
          {/* Unified Navigation */}
          <BottomNavigation 
            activeTab={activeTab}
  ...
  return (
    <>
      <div className="h-[100dvh] w-full flex bg-[#0F172A] overflow-hidden" style={{
        ...
        <div className="flex-1 md:ml-[80px] flex flex-col relative overflow-hidden">
          ...
          {needsCenteredLayout && (
            <div className="flex-1 flex items-start justify-center overflow-hidden bg-[#0B0E14]">
