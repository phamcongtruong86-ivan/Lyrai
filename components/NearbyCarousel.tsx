      ...
      <div className="fixed bottom-20 md:bottom-8 left-0 right-0 z-[70] pointer-events-none">
        <div className="max-w-md mx-auto px-4">
          ...
          <motion.div
            ...
            className="glass-panel p-2 md:p-3 pointer-events-auto shadow-2xl"
            style={{
          ...
          >
            ...
            <div className="flex items-center justify-center mb-2">
              <p className="text-xs text-slate-400">
                ...
                <span className="text-slate-300 text-sm">{places.length}</span>
                <span className="text-slate-500 ml-1.5">quán</span>
              </p>
            </div>
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                className="w-11 h-11 md:w-12 md:h-12 rounded-full bg-slate-800/80 border border-slate-700/50 flex items-center justify-center hover:bg-slate-700 disabled:opacity-30 disabled:cursor-not-allowed transition-all shrink-0"
              >
                  ...
                  <button
                    ...
                    className={`transition-all shrink-0 ${
                      index === currentIndex
                        ...
                        : 'w-2.5 h-2.5 bg-slate-600 hover:bg-slate-500 rounded-full'
                    }`}
